...
peer chaincode invoke -o localhost:8050 --ordererTLSHostnameOverride orderer2.e-jazah.id --tls --cafile ${PWD}/organizations/ordererOrganizations/e-jazah.id/orderers/orderer2.e-jazah.id/msp/tlscacerts/tlsca.e-jazah.id-cert.pem -C main-channel -n basic --peerAddresses localhost:9051 --tlsRootCertFiles ${PWD}/organizations/peerOrganizations/org1.e-jazah.id/peers/peer1.org1.e-jazah.id/tls/ca.crt -c '{"function":"UpdateUserPassword","Args":["admin","admin2","admin1"]}'
